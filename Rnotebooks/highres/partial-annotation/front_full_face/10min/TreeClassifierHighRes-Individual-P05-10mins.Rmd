...
`r paste(participantCodeList,collapse=", ")` &nbsp; **`r ((fp+fn)/(tp+tn+fp+fn))*100`** &nbsp; **`r  ((tp+tn)/(tp+tn+fp+fn))*100`** &nbsp; **`r (tp/(tp+fp))*100`** &nbsp; **`r (tp/(tp+fn))*100`** &nbsp; **`r (tn/(tn+fp))*100`** &nbsp; **`r (2*tp/(2*tp+fp+fn))*100`**
